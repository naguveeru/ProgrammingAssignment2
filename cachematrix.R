...
## makeCacheMatrix : This function will create a object which has list of 4 functions - 
...
##   If you try to set the same matrix again, a message will be printed stating that matrix is already set. 
...
## cacheSolve   : this function will take the object of type makeCacheMatrix and cache the inverse matrix. 
##                If the matrix inverse is already cached, it will be fetched from cache and not computed again.
##   Exception- If the supplied matrix is not invertible, the function will print error.
##   Return - if the matrix is invertible , function returns the inverse matrix. Otherwise NULL.
## 
